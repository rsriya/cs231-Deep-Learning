...
class CaptioningTransformer(nn.Module):
    ...
    def forward(self, features, captions):
        ...
        position_encoded_caption = self.positional_encoding(embedded_caption) 
        ...
        output = self.transformer(position_encoded_caption, projected_features, tgt_mask)
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        ############################################################################
        embedded_image = self.patch_embed(x)
        position_encoded_img = self.positional_encoding(embedded_image)
        output = self.transformer(position_encoded_img)
