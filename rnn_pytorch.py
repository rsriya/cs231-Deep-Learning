...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        vectorized_captions = word_embedding_forward(captions_in, W_embed)
        if self.cell_type == 'rnn':
            h = rnn_forward(vectorized_captions, h0, Wx, Wh, b)
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(max_length):
            vectorized_caption = word_embedding_forward(prev_word, W_embed)
            h_current = rnn_step_forward(vectorized_caption, h_prev, Wx, Wh, b)
            scores = affine_forward(h_current, W_vocab, b_vocab)
